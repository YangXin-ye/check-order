...
## 配置代码
### 异常响应类
![img_3.png](images/qiantai/img_3.png)
### 工具类
![img_4.png](images/qiantai/img_4.png)
## 登录拦截器
...
![img_5.png](images/qiantai/img_5.png)
![img_6.png](images/qiantai/img_6.png)
...
![img_7.png](images/qiantai/img_7.png)
...
![img_8.png](images/qiantai/img_8.png)
...
```
### 前后端联调
![img_9.png](images/qiantai/img_9.png)
## 删除收支记录接口
### 说明
```text
描述：删除收支记录接口
...
![img_10.png](images/qiantai/img_10.png)
## 删除银行卡接口
### 说明
```text
描述：删除银行卡接口
...
### 前后端联调
浏览器输入：http://localhost:8090/#/bankCard
![img_11.png](images/qiantai/img_11.png)
## 修改银行卡接口
### 说明
```text
描述：修改银行卡接口
...
![img_12.png](images/qiantai/img_12.png)
## 增加银行卡接口
### 说明
```text
描述：增加银行卡接口
...
![img_13.png](images/qiantai/img_13.png)
...
### 前后端联调
浏览器输入：http://localhost:8090/#/middle
![img_15.png](images/qiantai/img_15.png)
## 获取收支明细接口
### 说明
```text
描述：获取收支明细接口
...
![img_16.png](images/qiantai/img_16.png)
...
![img_18.png](images/qiantai/img_18.png)
...
![img_17.png](images/qiantai/img_17.png)
...
### 前后端联调
浏览器输入：http://localhost:8090/#/classfiy
![img_19.png](images/qiantai/img_19.png)
## 新增分类接口
### 说明
```text
描述：新增分类接口
...
![img_20.png](images/qiantai/img_20.png)
## 修改分类接口
### 说明
```text
描述：修改分类接口
...
![img_21.png](images/qiantai/img_21.png)
## 超出预算消息提醒接口
### 说明
```text
描述：超出预算消息提醒接口
...
![img_22.png](images/qiantai/img_22.png)
## 获取当前登录用户接口
### 说明
```text
描述：获取当前登录用户接口
...
### 前后端联调
浏览器输入：http://localhost:8090/#/personalCenter
![img_23.png](images/qiantai/img_23.png)
## 获取消费占比数据接口
### 说明
```text
描述：获取消费占比数据接口
...
### 前后端联调
浏览器输入：http://localhost:8090/#/personalCenter
![img_24.png](images/qiantai/img_24.png)
## 获取今日消费支出数据
### 说明
```text
描述：获取今日消费支出数据
...
### 前后端联调
浏览器输入：http://localhost:8090/#/personalCenter
![img_25.png](images/qiantai/img_25.png)
